package one_arrow.gameplay.world 
{
	 ...
	 * @author zeh fernando
	 */
	public static function loadSpaceFromRUBE(__rubeScene:Object, __scale:Number = 1, __lineThickness:Number = 1):Space {
...
static function loadBodyFromRUBE(__rubeBody:Object, __space:Space, __scale:Number, __lineThickness:Number):Body {
	// Main body
...
static function getCustomProperties(__rubeData:Object, __scale:Number):* {
	var obj:Object = {};
	loadUserDataFromRUBE(obj, __rubeData, __scale);
	return obj;
}

static function loadUserDataFromRUBE(__userData:*, __rubeData:Object, __scale:Number):void {
...
static function loadFixtureFromRUBE(__rubeFixture:Object, __body:Body, __scale:Number, __lineThickness:Number):Boolean {
	// Loads shapes
...
static function createPolygonEdges(__vertices:Vector.<Vec2>, __body:Body, __scale:Number, __lineThickness:Number, __isLoop:Boolean, __material:Material, __isSensor:Boolean):void {
...
static function fail(__message:String):void {
	trace("!!! loadSpaceFromRUBE ERROR: " + __message);
}

static function loadJointFromRUBE(__rubeJoint:Object, __space:Space, __spaceBodies:Vector.<Body>, __scale:Number):void {
	// Joint definition
...
static function getArrayFromProperty(__object:Object, __propertyName:String):Array {
...
static function getBooleanFromProperty(__object:Object, __propertyName:String, __default:Boolean = false):Boolean {
...
static function getVec2FromProperty(__object:Object, __propertyName:String, __scale:Number):Vec2 {
...
static function getYScale():Number {
	return -1;
}

static function getAngleScale():Number {
	return -1;
}

static function getVec2ArrayFromProperty(__object:Object, __propertyName:String, __scale:Number):Array {
...
static function getVec2VectorFromProperty(__object:Object, __propertyName:String, __scale:Number):Vector.<Vec2> {
	// This is needed because "vertices" is an object with an array of x and an array of y
...
static function getFloatFromProperty(__object:Object, __propertyName:String, __default:Number = 0):Number {
	if (!Boolean(__object)) return __default;
	if (!__object.hasOwnProperty(__propertyName)) return __default;
...
static function getIntegerFromProperty(__object:Object, __propertyName:String, __default:int = 0):int {
	if (!Boolean(__object)) return __default;
	if (!__object.hasOwnProperty(__propertyName)) return __default;
	if (isNaN(__object[__propertyName])) return __default;
	return __object[__propertyName];
...
static function getStringFromProperty(__object:Object, __propertyName:String, __default:String = ""):String {
	if (!Boolean(__object)) return __default;
	if (!__object.hasOwnProperty(__propertyName)) return __default;
	return __object[__propertyName];
}
